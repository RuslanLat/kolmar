...
from aiohttp.web import HTTPForbidden, HTTPUnauthorized, HTTPFound
...
class AdminLoginView(View):
    ...
    async def post(self) -> Response:
        ...
        admin: Optional[Admin] = await self.store.admins.get_by_login(login)
...
class AdminCurrentView(View):
    ...
    async def get(self) -> Response:
        ...
        admin_data = AdminResponseSchema().dump(self.request.admin)
